...
const ru = {
  ...
  send: 'Отправить', openChat: 'Открыть чат с помощником EKT', askAssistant: 'Спросить помощника',
  ...
  longQuery: 'Сообщение должно содержать не более 4000 символов.',
  ...
  exactMatch: 'Точное совпадение', compatible: 'Возможный аналог', inStock: 'В наличии', piece: 'шт.',
...
const kk: typeof ru = {
  ...
  send: 'Жіберу', openChat: 'EKT көмекшісімен чатты ашу', askAssistant: 'Көмекшіден сұрау',
  ...
  longQuery: 'Хабарлама 4000 таңбадан аспауы керек.',
  ...
  exactMatch: 'Дәл сәйкестік', compatible: 'Ықтимал балама', inStock: 'Қоймада', piece: 'дана',
